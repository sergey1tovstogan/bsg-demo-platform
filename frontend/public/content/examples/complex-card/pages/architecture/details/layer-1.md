...
sections:
  ...
  - type: "feature_grid"
    columns: 2
    features:
      - name: "Component B: Router"
        description: "Request routing logic (informational only)"
        icon: "ArrowRightLeft"
...
# Level 4 page
sub_pages:
  - file: "content/examples/complex-card/pages/architecture/details/layer-1/component-a.md"

...
card:
  ...
  # === AGENDA ===
  agenda:
    file: "content/examples/medium-card/agenda.md"
  ...
  # === PAGES (3 levels deep) ===
  pages:
    - file: "content/examples/medium-card/pages/overview.md"
      order: 1
    - file: "content/examples/medium-card/pages/architecture.md"  # Has sub-pages
      order: 2

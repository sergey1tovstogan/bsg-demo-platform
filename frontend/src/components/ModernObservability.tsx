            ...
            <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                    <div className="px-6 py-4 border-b border-slate-100 bg-slate-50">
                        <h3 className="font-bold text-slate-800">Log Sources</h3>
                    </div>
        ...
        <div className="space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                <div className="px-6 py-4 border-b border-slate-100 bg-slate-50 flex justify-between items-center">
                    <h3 className="font-bold text-slate-800">Incident Fix Time SLA</h3>
                    <span className="text-xs font-medium px-2 py-1 bg-blue-100 text-blue-700 rounded">Support Hours: 24 x 7 x 365</span>
                </div>
                <div className="overflow-x-auto">
                    <table className="w-full text-sm text-left">
                        <thead>
                            <tr className="bg-slate-50 border-b border-slate-200">
                                <th className="px-6 py-4 font-semibold text-slate-700 w-1/4">Severity</th>
                                ...
                                <th className="px-4 py-4 font-bold text-slate-600 text-center bg-slate-100">5<br /><span className="text-xs font-normal text-slate-500">Low</span></th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-slate-100">
                            {[
                                ...
                                <tr key={idx} className="hover:bg-slate-50">
                                    ...
                                    <td className="px-4 py-4 text-center text-slate-600 bg-red-50/30">{row.v1}</td>
                                    <td className="px-4 py-4 text-center text-slate-600 bg-orange-50/30">{row.v2}</td>
                                    <td className="px-4 py-4 text-center text-slate-600 bg-yellow-50/30">{row.v3}</td>
                                    <td className="px-4 py-4 text-center text-slate-600 bg-blue-50/30">{row.v4}</td>
                                    <td className="px-4 py-4 text-center text-slate-600 bg-slate-50/50">{row.v5}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-full">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 flex flex-col">
                ...
                <h3 className="text-lg font-bold text-slate-800 mb-4">Backup Policies</h3>
                <div className="space-y-6 flex-1">
                    <div>
                        <h4 className="font-semibold text-purple-700 mb-2">Database Backup</h4>
                        <p className="text-sm text-slate-600">After Go-live, DB backups of Class A & Class B Environments only. Other environments on ad-hoc basis.</p>
                    </div>
                    <div>
                        <h4 className="font-semibold text-teal-700 mb-2">System Backups</h4>
                        <p className="text-sm text-slate-600">After Go-live, system backups of Class A & Class B Environments at the end of every calendar month and year.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 flex flex-col">
                ...
                <h3 className="text-lg font-bold text-slate-800 mb-4">Restoration Policies</h3>
                <div className="space-y-4 flex-1">
                    <p className="text-sm font-medium text-slate-700">Class A Environment only:</p>
                    <ul className="space-y-3">
                        {[
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 flex flex-col">
                ...
                <h3 className="text-lg font-bold text-slate-800 mb-4">Long Term Retention</h3>
                <div className="space-y-4 flex-1">
                    <p className="text-sm font-medium text-slate-700">Class A Environment only:</p>
                    <ul className="space-y-3">
                        <li className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg border border-slate-100">
                            ...
                            <span className="text-sm text-slate-600">Months retention for EOM backups</span>
                        </li>
                        <li className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg border border-slate-100">
                            <span className="font-bold text-sky-700 text-lg">7</span>
                            <span className="text-sm text-slate-600">Years retention for EOY backups</span>
                        </li>
                    </ul>
    ...
    return (
        <div className="flex flex-col h-full space-y-6">
            <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 flex items-start gap-3">
                ...
                <div>
                    <h4 className="font-bold text-blue-900">Full History Audit Trail</h4>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden flex-1 flex flex-col">
                <div className="px-6 py-4 border-b border-slate-100 bg-slate-50 flex justify-between items-center">
                    <h3 className="font-bold text-slate-800">Audit Log Example</h3>
                    ...
                    <table className="w-full text-sm text-left whitespace-nowrap">
                        ...
                        <tbody className="divide-y divide-slate-100">
                            ...
                            <tr className="bg-slate-50/50 border-t-2 border-slate-100">
                                <td className="px-6 py-4 font-bold text-slate-800">2</td>
                                <td className="px-6 py-4">OFFICER</td>
                                <td className="px-6 py-4">23 MAY 23 08:57</td>
                                <td className="px-6 py-4 font-mono text-slate-600">CR.PROFILE.TYPE</td>
                            ...
                            <tr>
                                <td colSpan={3}></td>
                                <td className="px-6 py-2 font-mono text-slate-600">NET.MONTHLY.IN</td>

        ...
        <div className="w-full h-full bg-slate-50 dark:bg-slate-900 rounded-xl relative overflow-y-auto shadow-2xl border border-slate-200 dark:border-slate-800 p-8">
            ...
            <div className="relative z-10 mb-8 text-center">
                <div className="inline-flex items-center gap-3 bg-white dark:bg-slate-800 px-6 py-2 rounded-full shadow-lg border border-slate-200 dark:border-slate-700 mb-4">
                    ...
                    <h2 className="text-xl font-bold text-slate-800 dark:text-white">Temenos SaaS Cloud Segregation</h2>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-[calc(100%-120px)] relative z-10">
                ...
                <div className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-200 dark:border-slate-700 h-full relative group hover:border-amber-500/50 transition-all duration-300 flex flex-col">
                    ...
                    <div className="space-y-3 mt-auto">
                        <div className="p-3 bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 text-sm text-slate-700 dark:text-slate-200">
                ...
                {/* Column 2: Network */}
                <div className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-200 dark:border-slate-700 h-full relative group hover:border-cyan-500/50 transition-all duration-300 flex flex-col">
                    <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-cyan-100 dark:bg-cyan-900/30 text-cyan-700 dark:text-cyan-300 px-4 py-1 rounded-full text-sm font-bold border border-cyan-200 dark:border-cyan-800">
                        Network
                    </div>
                ...
                {/* Column 3: Database */}
                <div className="bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-200 dark:border-slate-700 h-full relative group hover:border-emerald-500/50 transition-all duration-300 flex flex-col">

  ...
  return (
    <div className="card">
      ...
      <div className="space-y-6">
        ...
        {/* Key Points */}
        <div className="mt-6">
          <h3 className="text-xl font-bold dark:text-white text-[#283054] mb-4">Key Points</h3>
          <div className="space-y-3">
            <div className="flex items-start space-x-3">
              <Check className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
              <div>
                <span className="font-semibold dark:text-gray-300 text-gray-900">Semantic Versioning (Major.Minor.Patch - xx.xx.xx)</span>
            ...
            <div className="flex items-start space-x-3">
              <Check className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
              <div>
                <span className="font-semibold dark:text-gray-300 text-gray-900">Change to API means a new version to be created</span>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <Check className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
              <div>
                <span className="font-semibold dark:text-gray-300 text-gray-900">Maintains backward compatibility</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6">
          <h3 className="text-xl font-bold dark:text-white text-[#283054] mb-4">Version Scenarios</h3>
